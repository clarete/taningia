 ...
 *
 *  - Added `hashtable_get_test' by Lincoln de Sousa <lincoln@comum.org>
 *
 */
...
/**
 * hashtable_get_test - Get a value associated with a key but test if
 * the key exists
 *
 * @hashtable: The hashtable object
 * @key: The key
 * @value: The output parameter that will be filled with the found
 * value.
 *
 * This function is different from hashtable_get because it can define
 * if a key exists and its value is NULL. The first one always returns
 * NULL.
 *
