...
static TA_INLINE void list_init(list_t *list)
{
    list->next = list;
    list->prev = list;
}

static TA_INLINE void list_insert(list_t *list, list_t *node)
{
    node->next = list;
    node->prev = list->prev;
    list->prev->next = node;
...
static TA_INLINE void list_remove(list_t *list)
{
    list->prev->next = list->next;
    list->next->prev = list->prev;
}

static TA_INLINE int bucket_is_empty(hashtable_t *hashtable, bucket_t *bucket)
{
